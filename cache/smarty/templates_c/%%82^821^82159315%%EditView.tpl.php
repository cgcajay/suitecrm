<?php /* Smarty version 2.6.31, created on 2019-05-09 11:27:43
         compiled from cache/themes/SuiteP/modules/Leads/EditView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'cache/themes/SuiteP/modules/Leads/EditView.tpl', 51, false),array('modifier', 'strip_semicolon', 'cache/themes/SuiteP/modules/Leads/EditView.tpl', 106, false),array('modifier', 'lookup', 'cache/themes/SuiteP/modules/Leads/EditView.tpl', 168, false),array('modifier', 'count', 'cache/themes/SuiteP/modules/Leads/EditView.tpl', 270, false),array('function', 'sugar_include', 'cache/themes/SuiteP/modules/Leads/EditView.tpl', 67, false),array('function', 'sugar_translate', 'cache/themes/SuiteP/modules/Leads/EditView.tpl', 88, false),array('function', 'counter', 'cache/themes/SuiteP/modules/Leads/EditView.tpl', 112, false),array('function', 'html_options', 'cache/themes/SuiteP/modules/Leads/EditView.tpl', 113, false),array('function', 'sugar_getimagepath', 'cache/themes/SuiteP/modules/Leads/EditView.tpl', 171, false),array('function', 'sugar_getjspath', 'cache/themes/SuiteP/modules/Leads/EditView.tpl', 640, false),array('block', 'minify', 'cache/themes/SuiteP/modules/Leads/EditView.tpl', 104, false),)), $this); ?>
...
<div class="col-xs-12 col-sm-4 label" data-label="LBL_CITY_NAME">

<?php $this->_tag_stack[] = array('minify', array()); $_block_repeat=true;smarty_block_minify($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_CITY_NAME','module' => 'Leads'), $this);?>
<?php $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
...
<div class="col-xs-12 col-sm-8 edit-view-field " type="enum" field="city_name_c"  >
<?php echo smarty_function_counter(array('name' => 'panelFieldCount','print' => false), $this);?>


<?php if (! isset ( $this->_tpl_vars['config']['enable_autocomplete'] ) || $this->_tpl_vars['config']['enable_autocomplete'] == false): ?>
<select name="<?php echo $this->_tpl_vars['fields']['city_name_c']['name']; ?>
" 
id="<?php echo $this->_tpl_vars['fields']['city_name_c']['name']; ?>
" 
title=''       
>
<?php if (isset ( $this->_tpl_vars['fields']['city_name_c']['value'] ) && $this->_tpl_vars['fields']['city_name_c']['value'] != ''): ?>
<?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['fields']['city_name_c']['options'],'selected' => $this->_tpl_vars['fields']['city_name_c']['value']), $this);?>

<?php else: ?>
<?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['fields']['city_name_c']['options'],'selected' => $this->_tpl_vars['fields']['city_name_c']['default']), $this);?>

<?php endif; ?>
</select>
<?php else: ?>
<?php $this->assign('field_options', $this->_tpl_vars['fields']['city_name_c']['options']); ?>
<?php ob_start(); ?><?php echo $this->_tpl_vars['fields']['city_name_c']['value']; ?>
...
<?php ob_start(); ?><?php echo $this->_tpl_vars['fields']['city_name_c']['name']; ?>
<?php $this->_smarty_vars['capture']['ac_key'] = ob_get_contents(); ob_end_clean(); ?>
<?php $this->assign('ac_key', $this->_smarty_vars['capture']['ac_key']); ?>
<select style='display:none' name="<?php echo $this->_tpl_vars['fields']['city_name_c']['name']; ?>
" 
id="<?php echo $this->_tpl_vars['fields']['city_name_c']['name']; ?>
" 
title=''          
...
id="<?php echo $this->_tpl_vars['fields']['city_name_c']['name']; ?>
-input"
name="<?php echo $this->_tpl_vars['fields']['city_name_c']['name']; ?>
-input"
size="30"
...
id="btn-clear-<?php echo $this->_tpl_vars['fields']['city_name_c']['name']; ?>
-input"
title="Clear"
onclick="SUGAR.clearRelateField(this.form, '<?php echo $this->_tpl_vars['fields']['city_name_c']['name']; ?>
-input', '<?php echo $this->_tpl_vars['fields']['city_name_c']['name']; ?>
');sync_<?php echo $this->_tpl_vars['fields']['city_name_c']['name']; ?>
...
<?php echo $this->_tpl_vars['fields']['city_name_c']['name']; ?>
<?php echo '");
...
.inputNode = Y.one('#<?php echo $this->_tpl_vars['fields']['city_name_c']['name']; ?>
-input');
	SUGAR.AutoComplete.<?php echo $this->_tpl_vars['ac_key']; ?>
.inputImage = Y.one('#<?php echo $this->_tpl_vars['fields']['city_name_c']['name']; ?>
-image');
	SUGAR.AutoComplete.<?php echo $this->_tpl_vars['ac_key']; ?>
.inputHidden = Y.one('#<?php echo $this->_tpl_vars['fields']['city_name_c']['name']; ?>
');
...
<?php echo '\' );
addToValidate(\'EditView\', \'city_name_c\', \'enum\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_CITY_NAME','module' => 'Leads','for_js' => true), $this);?>
<?php echo '\' );
