...
<div class="col-xs-12 col-sm-8 detail-view-field inlineEdit" type="enum" field="city_name_c"  >

<?php if (! $this->_tpl_vars['fields']['city_name_c']['hidden']): ?>
<?php echo smarty_function_counter(array('name' => 'panelFieldCount','print' => false), $this);?>



<?php if (is_string ( $this->_tpl_vars['fields']['city_name_c']['options'] )): ?>
<input type="hidden" class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['city_name_c']['name']; ?>
" value="<?php echo $this->_tpl_vars['fields']['city_name_c']['options']; ?>
">
<?php echo $this->_tpl_vars['fields']['city_name_c']['options']; ?>

<?php else: ?>
<input type="hidden" class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['city_name_c']['name']; ?>
" value="<?php echo $this->_tpl_vars['fields']['city_name_c']['value']; ?>
">
<?php echo $this->_tpl_vars['fields']['city_name_c']['options'][$this->_tpl_vars['fields']['city_name_c']['value']]; ?>
...
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_SALUTATION','module' => 'Leads'), $this);?>
<?php $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</div>
...
<div class="col-xs-12 col-sm-8 detail-view-field inlineEdit" type="enum" field="salutation"  >
