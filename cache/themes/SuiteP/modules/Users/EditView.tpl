...
<a class="" role="button" data-toggle="collapse-edit" aria-expanded="false">
<div class="col-xs-10 col-sm-11 col-md-11">
{sugar_translate label='LBL_CTIUSER_PANEL' module='Users'}
</div>
</a>
</div>
...
{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_PHONEEXTENSION' module='Users'}{/capture}
{$label|strip_semicolon}:
...
maxlength='10' 
value='{$value}' title='Enter Your Extension'      >
</div>
...
{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_ASTERISK' module='Users'}{/capture}
{$label|strip_semicolon}:
...
{if strlen($fields.asteriskname_c.value) <= 0}
{assign var="value" value=$fields.asteriskname_c.default_value }
{else}
{assign var="value" value=$fields.asteriskname_c.value }
{/if}  
<input type='text' name='{$fields.asteriskname_c.name}' 
id='{$fields.asteriskname_c.name}' size='30' 
maxlength='20' 
value='{$value}' title='Enter Your Asterisk IP'      >
</div>
...
{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_SHOWCLICKTOCALL' module='Users'}{/capture}
{$label|strip_semicolon}:
...
value="1" title='Tick to Show Magic Dial Button' tabindex="0" {$checked} >
</div>
...
{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_DIALOUTPREFIX' module='Users'}{/capture}
{$label|strip_semicolon}:
...
{if strlen($fields.dialout_prefix_c.value) <= 0}
{assign var="value" value=$fields.dialout_prefix_c.default_value }
{else}
{assign var="value" value=$fields.dialout_prefix_c.value }
{/if}  
<input type='text' name='{$fields.dialout_prefix_c.name}' 
id='{$fields.dialout_prefix_c.name}' size='30' 
maxlength='30' 
value='{$value}' title='Enter Dial Out Prefix'      >
</div>
...
{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_DIALPLAN' module='Users'}{/capture}
{$label|strip_semicolon}:
...
{if strlen($fields.dial_plan_c.value) <= 0}
{assign var="value" value=$fields.dial_plan_c.default_value }
{else}
{assign var="value" value=$fields.dial_plan_c.value }
{/if}  
<input type='text' name='{$fields.dial_plan_c.name}' 
id='{$fields.dial_plan_c.name}' size='30' 
maxlength='30' 
value='{$value}' title='Enter Dial Plan'      >
</div>
...
addToValidate('EditView', 'call_notification_c', 'bool', false,'{/literal}{sugar_translate label='LBL_CALL_NOTIFICATION' module='Users' for_js=true}{literal}' );
addToValidate('EditView', 'asteriskname_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_ASTERISK' module='Users' for_js=true}{literal}' );
addToValidate('EditView', 'dial_plan_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_DIALPLAN' module='Users' for_js=true}{literal}' );
addToValidate('EditView', 'phoneextension_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_PHONEEXTENSION' module='Users' for_js=true}{literal}' );
addToValidate('EditView', 'dialout_prefix_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_DIALOUTPREFIX' module='Users' for_js=true}{literal}' );
addToValidate('EditView', 'showclicktocall_c', 'bool', false,'{/literal}{sugar_translate label='LBL_SHOWCLICKTOCALL' module='Users' for_js=true}{literal}' );
