        ...
        echo '<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.3.1/jquery.min.js"></script>
            <script>
                $(document).ready(function(){
                        ...
                        var cityNumber = $("#city_name_c").val();
                        $.ajax({
                            url:"city.php",
                            method:"post",
                            data:{cityNumber:cityNumber,salutation:salutation},
                            success:function(data){
                                
                                $("#city_name_c").get(0).type = "text";
                                $("#city_name_c").val(data);
                                $("#city_name_c").attr("disabled","disabled");
                            }
                            });
                    });
            </script>
